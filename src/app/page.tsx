            ...
            <ScrollReveal variant="fadeRight" duration={0.8} className="lg:col-span-5 space-y-8 text-left">
              <div className="space-y-4">
                <div className={`inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full border text-xs font-bold ${
                  ...
                  <span className="uppercase tracking-widest text-[10px]">Precision Vector AI Search Optimization</span>
                </div>

                <h1 className={`text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.08] ${
                  isDark ? 'text-[#F6F6F4]' : 'text-[#181818]'
                }`}>
                  Command AI Search Citations Across{' '}
                ...
                <p className={`text-base sm:text-lg leading-[1.7] ${
                  ...
                  TangentCore empowers enterprise brands to audit, structure JSON-LD schemas, and outrank competitors in conversational responses generated by ChatGPT, Gemini, Perplexity, Claude, DeepSeek, and Grok.
                </p>
              </div>

              {/* Instant Hero Scan Input */}
              <form onSubmit={handleHeroSearch} className="space-y-3 max-w-md">
                <div className="relative">
                  ...
                  <input
                    ...
                    } border rounded-2xl pl-11 pr-32 py-3.5 text-xs focus:outline-none transition-all shadow-md`}
                  />
                  <button
                    type="submit"
                    className="absolute right-1.5 top-1.5 bottom-1.5 px-4 rounded-xl luxury-btn-primary text-xs font-bold flex items-center gap-1.5 shadow-md"
                  >
                    <span>Free Scan</span>
                    <ArrowRight className="w-3.5 h-3.5" />
                  </button>
                </div>
                <div className={`flex items-center gap-4 text-[11px] ${isDark ? 'text-[#B7B7B5]/70' : 'text-[#5C5C5C]'}`}>
                  <span className="flex items-center gap-1">
                    <CheckCircle2 className="w-3.5 h-3.5 text-[#C7A15A]" /> Instant GEO Audit
                  </span>
                  <span className="flex items-center gap-1">
                    <ShieldCheck className="w-3.5 h-3.5 text-[#B87333]" /> Zero API Key Required
                  </span>
                </div>
              </form>
